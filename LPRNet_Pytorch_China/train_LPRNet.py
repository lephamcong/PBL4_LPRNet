...
def get_parser():
    ...
    parser.add_argument('--train_img_dirs', default="./data/DataChina/train", help='the train images path')
    parser.add_argument('--test_img_dirs', default="./data/DataChina/valid", help='the test images path')
